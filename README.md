...
- If/when the update completes successfully, it will exit back to the command line.

- If an error occurs, the updater window will remain open until you close it.
